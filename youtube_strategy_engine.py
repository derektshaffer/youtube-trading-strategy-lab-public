...
class GeminiVideoAnalyzer:
    ...
    def _analyze_video_section(
        ...
        *,
        ...
        payload = {
            ...
            "generationConfig": {
                "responseFormat": {
                    "text": {"mimeType": "application/json", "schema": VIDEO_ANALYSIS_SCHEMA}
                }
            },
        }
    ...
    def _analyze_long_video(
        ...
        for index in range(total):
            ...
            if progress:
                progress(index, total, f"Analyzing {label}…")
            try:
                ...
                message = str(exc)
                if "rate limit" in message.lower() or "usage" in message.lower():
                    message += " Google's free Gemini tier allows up to eight hours of YouTube video analysis per day."
