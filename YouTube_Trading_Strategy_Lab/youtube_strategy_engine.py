...
class StrategyStore:
    ...
    def blank() -> dict[str, Any]:
        return {"version": 1, "videos": [], "strategies": [], "paper_positions": [], "updated_at": None}
    ...
    def load(self) -> dict[str, Any]:
        ...
        result = self.blank()
        result.update(data)
        for name in ("videos", "strategies", "paper_positions"):
    ...
    def add_video_analysis(self, analysis: dict[str, Any]) -> dict[str, Any]:
        ...
        for strategy in analysis.get("strategies") or []:
            ...
            item["approved"] = bool(existing.get("approved", item.get("approved", False)))
